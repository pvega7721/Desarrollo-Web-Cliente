...
export class ArticuloComponent {
  ...
  articulos: Articulo[] = [ // Usar la interfaz Articulo para definir el tipo del array
  ...
  unidades: number = 0;
  comprar(){
    this.articulos.push({nombre: this.nombre, precio: this.precio, unidades: this.unidades});
  }
}
