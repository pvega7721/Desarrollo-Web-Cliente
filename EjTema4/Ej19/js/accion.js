...
function marcarTodos() {
  var checkboxes = document.getElementsByTagName("input"); //esto es un htmlcollection, para recorrerlo con foreach hay que pasarlo a array antes
  var arrayCheckbox = Array.from(checkboxes);
...
inicio = () => {
  document.getElementById("marcarTodo").addEventListener("click", marcarTodos);
  document
    .getElementById("desmarcarTodo")
    .addEventListener("click", desmarcarTodos);
  document
    .getElementById("borrarMarcados")
